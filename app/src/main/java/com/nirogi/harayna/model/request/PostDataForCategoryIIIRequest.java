...
public class PostDataForCategoryIIIRequest {
...
String  category;
String  userId;
String  histroyAdmIllness;
String  historyFamily;
String  immunStatus;
String  contactWithTB;
String  historyDeworming;
String  weight;
String  height;
String  bmi;
String  pallor;
...
String  wristWidening;
String  vitADeficiency;
String  gonadalExamination;
String  earDischarge;
String  speech;
String  iq;
String  skinTurgor;
...
String  prescription;
  ...
  public String getGonadalExamination() {
    return gonadalExamination;
  }

  public void setGonadalExamination(String gonadalExamination) {
    this.gonadalExamination = gonadalExamination;
  }
